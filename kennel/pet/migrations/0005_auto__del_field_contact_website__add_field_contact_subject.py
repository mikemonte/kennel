...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'pet_contact', 'website')

        # Adding field 'Contact.subject'
        db.add_column(u'pet_contact', 'subject',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'pet_contact', 'website',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Deleting field 'Contact.subject'
        db.delete_column(u'pet_contact', 'subject')
    ...
    models = {
        ...
        u'pet.pet': {
            ...
            'age': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'max_length': '2', 'null': 'True', 'blank': 'True'}),
