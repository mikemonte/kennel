...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Blog'
        db.create_table(u'pet_blog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('story_description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('story', self.gf('django.db.models.fields.CharField')(max_length=5000)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal(u'pet', ['Blog'])


    def backwards(self, orm):
        # Deleting model 'Blog'
        db.delete_table(u'pet_blog')
