...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IndexPhoto'
        db.create_table(u'pet_indexphoto', (
        ...
        db.send_create_signal(u'pet', ['IndexPhoto'])


    def backwards(self, orm):
        # Deleting model 'IndexPhoto'
        db.delete_table(u'pet_indexphoto')
