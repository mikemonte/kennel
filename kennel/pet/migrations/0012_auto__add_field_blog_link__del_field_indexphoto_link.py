...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.link'
        db.add_column(u'pet_blog', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'IndexPhoto.link'
        db.delete_column(u'pet_indexphoto', 'link')


    def backwards(self, orm):
        # Deleting field 'Blog.link'
        db.delete_column(u'pet_blog', 'link')

        # Adding field 'IndexPhoto.link'
        db.add_column(u'pet_indexphoto', 'link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'pet.indexphoto': {
            'Meta': {'ordering': "['-modified']", 'object_name': 'IndexPhoto'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
