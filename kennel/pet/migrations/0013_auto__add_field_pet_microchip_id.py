...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pet.microchip_id'
        db.add_column(u'pet_pet', 'microchip_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=55, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pet.microchip_id'
        db.delete_column(u'pet_pet', 'microchip_id')
    ...
    models = {
        ...
        u'pet.pet': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'microchip_id': ('django.db.models.fields.CharField', [], {'max_length': '55', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '55'}),
            'picture': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'salt': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
